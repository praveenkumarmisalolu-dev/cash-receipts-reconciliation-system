...
import com.crrs.service.EmployeesService2;

@Controller
@RequestMapping("/employees")
public class EmployeesController2 {
	
	private static final Logger logger = LogManager.getLogger(EmployeesController2.class);
	
	
	@Autowired
    private EmployeesService2 employeesService;
